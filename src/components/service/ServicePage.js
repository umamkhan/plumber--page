...
const ServicePage = () => {
  return (
    ...
    <div>
    <div className=" xl:fixed  flex flex-wrap  justify-center items-center xl:w-[30%] lg:w-[full] h-[full] md:w-[full] sm:w-[full] border border-gray-200 mx-12 rounded-xl  ">
    <div>
